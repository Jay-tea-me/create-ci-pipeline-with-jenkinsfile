...
pipeline {
  ...
  stages {
    ...
    stage("commit version update") {
      steps {
        script {
          withCredentials([usernamePassword(credentialsId: '95b99489-575d-4f46-a907-cad03fee42ed', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
            ...
            sh "git push https://${USER}:${PASS}@github.com/Jay-tea-me/create-ci-pipeline-with-jenkinsfile.git HEAD:jenkins-shared-lib"
